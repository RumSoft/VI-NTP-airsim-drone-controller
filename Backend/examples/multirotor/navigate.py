...
while True:
    ...
    if (result == "\0"):
        ...
        distance = maxes[min]  # 255 - maxes[min]
        ...
        if (distance > current + 30):
            ...
            vx = math.cos(yaw)
            vy = math.sin(yaw)
            print("switching angle", math.degrees(
                yaw), vx, vy, min, distance, current)
        ...
        client.moveByVelocityZAsync(
            vx, vy, -6, 1, airsim.DrivetrainType.ForwardOnly, airsim.YawMode(False, 0)).join()
